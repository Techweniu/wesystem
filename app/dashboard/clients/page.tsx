...
async function getAnalyticsData() {
    ...
    // Calculate NPS summary (Detractors, Passives, Promoters) for the current month
    const npsSummaryData = { detractors: 0, passives: 0, promoters: 0 };
    currentMonthNps?.forEach(r => {
        if(r.score <= 7) npsSummaryData.detractors++; // Updated: 0-7 are detractors
        else if (r.score === 8) npsSummaryData.passives++; // Updated: 8 are passives
