        ...
        >
          <div className="space-y-4 py-4 pr-2">
            ...
            <div className="grid grid-cols-3 gap-4">
              ...
              <div className="grid gap-2">
                <Label htmlFor="health_status">Saúde*</Label>
              ...
              <div className="grid gap-2">
                <Label htmlFor="credit_risk">Risco</Label>
                <Input id="credit_risk" name="credit_risk" defaultValue={client.credit_risk || ""} />
              </div>
            </div>
            ...
            <div className="space-y-4">
              ...
              <div className="flex items-center justify-between rounded-lg border p-3 shadow-sm">
                <Label htmlFor="has_traffic_service-switch" className="flex flex-col space-y-1 cursor-pointer">
                  <span>Possui Tráfego?</span>
                  <span className="font-normal text-muted-foreground text-xs">...</span>
                </Label>
                <Switch id="has_traffic_service-switch" checked={hasTraffic} onCheckedChange={setHasTraffic} />
              </div>
              <div className="flex items-center justify-between rounded-lg border p-3 shadow-sm">
                <Label htmlFor="ad_account_organized-switch" className="flex flex-col space-y-1 cursor-pointer">
                  <span>Conta Organizada?</span>
                  <span className="font-normal text-muted-foreground text-xs">...</span>
                </Label>
                <Switch id="ad_account_organized-switch" checked={isOrganized} onCheckedChange={setIsOrganized} />
              </div>
              <div className="flex items-center justify-between rounded-lg border p-3 shadow-sm">
                ...
                <Switch id="ads_running-switch" checked={isRunning} onCheckedChange={setIsRunning} />
              </div>
            </div>
            ...
            <div className="space-y-4">
              ...
              <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
                ...
                <div className="grid gap-2">
                  ...
                  <Select
                    name="assigned_relationship_manager_id"
                    value={selectedManager}
                    onValueChange={setSelectedManager}
                  >
                    <SelectTrigger id="assigned_relationship_manager_id">
