...
import { PlusCircle, FileText, BarChart2, FileSignature, Users } from "lucide-react"
...
export function AddClientForm({ 
  ...
  return (
    <Dialog open={open} onOpenChange={setOpen}>
      ...
      {/* CORREÇÃO: Removido ScrollArea e ajustado o layout flexível para garantir rolagem nativa */}
      <DialogContent className="sm:max-w-[800px] h-[90vh] flex flex-col p-0 gap-0">
        <DialogHeader className="px-6 py-4 border-b shrink-0">
          <DialogTitle>Cadastrar Novo Cliente</DialogTitle>
          <DialogDescription>
            Preencha as informações do cliente, contrato e equipe responsável.
          </DialogDescription>
        </DialogHeader>
        
        {/* O Form ocupa todo o espaço restante (flex-1) e esconde o overflow geral */}
        <form ref={formRef} action={handleFormSubmit} className="flex flex-col flex-1 min-h-0">
          
          {/* Container de Rolagem Nativa: flex-1 e overflow-y-auto garantem o scroll aqui */}
            ...
            <div className="space-y-4">
              ...
              <div className="grid gap-4 sm:grid-cols-2">
                <div className="space-y-2">
                  ...
                  <Select name="assigned_assessor_id">
                    <SelectTrigger>
                ...
                <div className="space-y-2">
                  ...
                  <Select name="assigned_relationship_manager_id">
                    <SelectTrigger>
                      <SelectValue placeholder="Selecione..." />
                    </SelectTrigger>
                    <SelectContent>
                ...
                <div className="space-y-2">
                  <Label htmlFor="assigned_videomaker_id">Videomaker</Label>
                  <Select name="assigned_videomaker_id">
                    <SelectTrigger>
                      <SelectValue placeholder="Selecione..." />
                    </SelectTrigger>
                    <SelectContent>
                ...
                <div className="space-y-2">
                  <Label htmlFor="assigned_editor_id">Editor</Label>
                  <Select name="assigned_editor_id">
                    <SelectTrigger>
                      <SelectValue placeholder="Selecione..." />
                    </SelectTrigger>
                    <SelectContent>
