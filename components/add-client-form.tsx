  ...
  return (
    <Dialog open={open} onOpenChange={setOpen}>
      ...
      <DialogContent className="sm:max-w-[800px] max-h-[90vh] p-0 flex flex-col">
        ...
        {/* O formulário envolve tudo, incluindo o footer, para o botão funcionar corretamente */}
        <form ref={formRef} action={handleFormSubmit} className="flex flex-col flex-1 overflow-hidden">
